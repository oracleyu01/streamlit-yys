...
with st.form(key ='Form1'):
    with st.sidebar:
        ...
        select_language =  st.sidebar.radio('고객이 원하는 데이터를 분석하기 편하도록', ('금리와 집값 고객 맞춤 데이터 시각화', '한국 야구 고객 맞춤 데이터 시각화', '다른 데이터 분석'))
        
        
if select_language =='금리와 집값 고객 맞춤 데이터 시각화':  
    tab1, tab2 = st.tabs(["📈 Chart", "🗃 Data"])
   
    with tab1:
        tab1.subheader("금리와 집값과의 관계 고객 맞춤 데이터 시각화")
        plotting_demo()
...
elif select_language =='한국 야구 고객 맞춤 데이터 시각화':
